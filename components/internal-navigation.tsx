  ...
  return (
    <nav className="sticky top-0 z-50 border-b border-white/10 bg-[#09090b]/90 text-white backdrop-blur-xl">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-5 sm:px-8">
        <a href="/" className="font-mono text-sm font-semibold tracking-[0.18em]">EC<span className="text-cyan-300">.</span></a>
        <div className="flex items-center gap-1 sm:gap-3">
          ...
          <a href="mailto:Emmanuel.castro.pantoja@gmail.com" className="inline-flex items-center gap-1 rounded-full bg-cyan-300 px-4 py-1.5 text-sm font-medium text-[#02090a] hover:bg-cyan-200">Let&apos;s talk <ArrowUpRight className="size-4" /></a>
        </div>
      </div>
    </nav>
  );
